...
// generated by gosite generate from gosite.yml - do not edit.
// `gosite generate` rewrites this file. Put local settings in config.local.php.
//
// gosite's Cockpit configuration, merged over the defaults in bootstrap.php by
// config.php, with config.local.php merged last.
//
...
$config = [
    ...
    // gosite addons this site does not enable in gosite.yml. They are all in
    // the CMS image; Cockpit skips loading any module named here.
    'modules.disabled' => __DISABLED_ADDONS__,
